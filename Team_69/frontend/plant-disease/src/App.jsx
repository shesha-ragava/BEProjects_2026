...
const PotatoPlantDisease = () => {
  ...
  // Handle image processing (works for both upload and camera capture)
    ...
    <div className='Renderthispotato'>
      <div className="content-wrapper">
        ...
        <div className="form-container">
          ...
          {/* Treatment Plan - Show for all predictions */}
          {prediction && (
            <TreatmentPlan diseaseName={prediction.class} mongoData={causes} compact={true} />
          )}
